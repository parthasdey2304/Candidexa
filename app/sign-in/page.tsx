...
export default function SignInAliasPage() {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const msg = (caughtError as { message?: string })?.message?.toLowerCase().includes("invalid") ? "Invalid credentials" : (caughtError as { message?: string })?.message || "We couldn't sign you in. Please try again.";
      setError(msg);
    } finally {
      setSubmitting(false);
    }
